...
class ProjectManagerDialog(QDialog):
    ...
    def __init__(self, managers: List[Dict[str, str]], current_index: int = -1, parent=None):
        super().__init__(parent)
        self.setWindowTitle("Проджект менеджер")
        ...
        self.combo.addItem("<Новый менеджер>")
        ...
        layout.addWidget(QLabel("Имя и фамилия (RU):"))
        self.name_ru_edit = QLineEdit()
        layout.addWidget(self.name_ru_edit)

        layout.addWidget(QLabel("Имя и фамилия (EN):"))
