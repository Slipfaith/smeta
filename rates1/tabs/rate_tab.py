...
class RateTab(QWidget):
    ...
    def __init__(self, lang_getter, parent=None):
        ...
        self.available_container.setFixedWidth(240)
        ...
        self.selected_label.setFixedWidth(240)
        ...
        self.selected_container.setFixedWidth(240)
        ...
        self.language_search_layout = QHBoxLayout()
        self.language_search_layout.setContentsMargins(0, 0, 0, 0)
        self.language_search_layout.setSpacing(0)
        self.language_search_layout.addWidget(self.available_search, alignment=Qt.AlignLeft)
        self.language_search_layout.addStretch(1)

        self.language_labels_layout = QHBoxLayout()
        self.language_labels_layout.setContentsMargins(0, 0, 0, 0)
        self.language_labels_layout.setSpacing(12)
        self.language_labels_layout.addWidget(self.available_label, alignment=Qt.AlignLeft)
        self.language_labels_layout.addWidget(self.selected_label, alignment=Qt.AlignLeft)
        self.language_labels_layout.addStretch(1)

        self.layout_main.addLayout(self.language_search_layout)
        self.layout_main.addLayout(self.language_labels_layout)
