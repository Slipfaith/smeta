...
### Экспорт
Сохранение проекта в JSON, выгрузка КП в Excel и PDF. PDF требует установленный Excel и `pywin32` на Windows. Шаблоны находятся в каталоге `templates/` и поддерживают корпоративный брендинг.
