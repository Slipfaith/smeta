TRANSLATIONS = {
    ...
    "Справка": {"ru": "Справка", "en": "Help"},
    "Открыть папку логов": {"ru": "Открыть папку логов", "en": "Open log folder"},
    "Путь к логам: {0}": {"ru": "Путь к логам: {0}", "en": "Log file: {0}"},
    "Папка логов не найдена": {"ru": "Папка логов не найдена", "en": "Log folder not found"},
    "Не удалось открыть папку логов": {
        "ru": "Не удалось открыть папку логов",
